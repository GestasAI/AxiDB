<?php
/**
 * AxiDB - Core\Vectores: los indices vectoriales de todas las colecciones.
 *
...
final class Vectores
{
    /** @var array<string, Indice|null> null significa "esta coleccion no tiene" */
    ...
    public function indice(string $coleccion): Indice
    {
    ...
    private function de(string $coleccion): ?Indice
    {
