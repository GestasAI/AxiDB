<?php
/**
 * AxiDB - Fachada\WithHealth: saber que esta pasando, desde Db.
 *
...
trait WithHealth
{
    ...
    {
        return (new Health($this))->stats($collection);
    }
    ...
    {
        return (new Health($this))->checkup();
    }
}
