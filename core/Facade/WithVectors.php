<?php
/**
 * AxiDB - Fachada\WithVectors: la busqueda por significado de Db.
 *
...
trait WithVectors
{
     ...
     * resultado sin que nadie pueda justificarlo. Ver Vector\Hybrid.
     *
    ...
    public function hybrid(string $collection, string $texto, int $k = 10): array
    {
        ...
        $fuera = [];
        foreach (Vector\Hybrid::fundir($porSignificado, $porPalabra, $k) as $fila) {
